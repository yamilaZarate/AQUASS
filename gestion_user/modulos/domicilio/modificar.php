...
$id_medidor_domicilio = $_GET['id_medidor_domicilio'];
$medidor= $_GET['id_medidor'];

$domicilio = MedidorDomicilio::obtenerPorIdMD($id_medidor_domicilio);
...
<body>
	...
	<div class="container">
		<div class="form__top">
			<h2>Formulario Modificar <span>Domicilio</span></h2><div> 
  <span><?php echo $medidor; ?></span>
</div>
		</div>
	...
	<input type="hidden" name="txtIdMedidor" value="<?php echo $id_medidor_domicilio; ?>">
	<input type="hidden" name="txtId" value="<?php echo $medidor; ?>">
		
		<div class="row col-xs-12">
			<div class="form-group">
			<label style="color:#FFFFFF"><center>Pais</center></label>
		...
		<br>
		<div class="form-group">
    		<label for="name1" style="color:#FFFFFF"> <center>Provincia</center></label>
    		<center><select id="select2lista" class="input"  name="select2lista" required>
  			...
  			<br>
			<div class="form-group">
    		<label for="name1" style="color:#FFFFFF"><center>Localidad</center></label>
			...
			<br>
			<div class="form-group">
    		<label for="name1" style="color:#FFFFFF"><center>Barrio</center></label>
