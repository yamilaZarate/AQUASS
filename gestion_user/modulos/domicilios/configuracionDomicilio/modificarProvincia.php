...
<body>
	...
	<div class="container">
		<div class="form__top">
			<h2>Formulario Modificar <span>Provincia</span></h2>
		</div>


	

	<form method="POST" action="procesar_modificacionProvincia.php"  class="form__reg" name="formulario" id="formulario">
	     ...
	     <!-- Grupo: Nombre -->
			<div class="formulario__grupo" id="grupo__nombre">
				...
				<div class="formulario__grupo-input">
					<input type="text" class="formulario__input" name="nombre" id="nombre" value="<?php echo $provincia->getDescripcion(); ?>" >
