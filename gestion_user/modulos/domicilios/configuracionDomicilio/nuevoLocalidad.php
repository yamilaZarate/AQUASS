...
<body>
	...
	<main>
		...
		<div class="container">
			<div class="form__top">
				<h2>Formulario Añadir <span>Localidad</span></h2>
			</div>	

			<form method="POST" action="procesar_altaLocalidad.php" class="form__reg" name="formulario" id="formulario">
				<?php
			...
			<div class="formulario__grupo" id="grupo__nombre">
				...
				<div class="formulario__grupo-input">
					<input type="text" class="formulario__input" name="nombre" id="nombre" placeholder="Formosa">
