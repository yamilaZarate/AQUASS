...
<body>
	...
	<div class="container">
		<div class="form__top">
			<h2>Formulario Modificar <span>Barrio</span></h2>
		</div>


	

	<form method="POST" action="procesar_modificacionBarrio.php"  class="form__reg" name="formulario" id="formulario">
		...
		echo $mensaje;
	     ...
	     <!-- Grupo: Nombre -->
			<div class="formulario__grupo" id="grupo__nombre">
				<label for="nombre" class="formulario__label">Nombre del Barrio</label>
				<div class="formulario__grupo-input">
					<input type="text" class="formulario__input" name="nombre" id="nombre" value="<?php echo $barrio->getDescripcion(); ?>" >
