...
<body>
	...
	<main>
		...
		<div class="container">
			<div class="form__top">
				<h2>Formulario Añadir <span>Barrio</span></h2>
			</div>	

			<form method="POST" action="procesar_altaBarrio.php" class="form__reg" name="formulario" id="formulario">
				<?php
