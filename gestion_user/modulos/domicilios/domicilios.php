...
//	case 'medidor':
//		$medidor = Medidor::obtenerPorIdMedidor($idMedidor);
//		echo "viene de medidor";
//		exit;
//		break;
						...
						<?php foreach  ($listadoDomicilios as $domicilio): ?>
							<tbody>
								<tr>
									...
									<td>
										<a href="modificar.php?id_persona_domicilio=<?php echo $domicilio->getIdPersonaDomicilio(); ?>&id_persona=<?php echo $domicilio->getIdPersona(); ?>"><span class="icon icon-pencil"></span></a>
									</td>
									<td>
										<a href="eliminar.php?id_persona_domicilio=<?php echo $domicilio->getIdPersonaDomicilio(); ?>&id_persona=<?php echo $domicilio->getIdPersona(); ?>"><span class="icon icon-bin2"></span></a>
									</td>
								</tr>
