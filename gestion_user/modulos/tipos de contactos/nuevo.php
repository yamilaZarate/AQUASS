...
<html>
<head>
	<script src="../../js/validaciones/validarTipoContacto.js"></script>
	<title></title>
	...
	<div id="primerContenedor">
		<div id="contenedorgeneral">
			...
			<form align="center" method="POST" action="procesar_alta.php">
				<h3 align="center">Registrar Tipo de contacto</h3>
				
				<input type="hidden" name="txtIdContacto" value="<?php echo $idcontacto?>">
