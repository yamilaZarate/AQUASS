	...
	<div id="primerContenedor">
		<div id="contenedorgeneral">
			...
			<form align="center" method="POST" action="procesar_modificar.php">
				<h3 align="center">Modificar Datos del Servicio</h3>

				<input type="hidden" name="txtIdServicio" value="<?php echo $id_servicio; ?>">

				Descripcion: <input type="text" name="txtDescripcion" value="<?php echo $tipoServicio->getDescripcion(); ?>"required== $0>
				<br><br>

				Cargo Fijo: <input type="text" name="txtCargoFijo" value="<?php echo $tipoServicio->getCargoFijo(); ?>"required== $0>
				<br><br>

				Cargo Variable: <input type="text" name="txtCargoVariable" value="<?php echo $tipoServicio->getCargoVariable(); ?>"required== $0>
				<br><br>
