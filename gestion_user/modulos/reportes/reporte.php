...
$sql = "SELECT id_factura,numero,fecha_emision,id_estado_pago,id_periodo,id_medidor 
		FROM factura WHERE id_estado_pago = 2";
...
$pdf->Cell(40,5,"cliente",1,0,"C");
$pdf->Cell(40, 5, "Numero de factura", 1, 0, "C");
...
while ($fila = $resultado->fetch_assoc()) {
	$pdf->Cell(40, 5, $fila['cliente'], 1, 0, "C");
	$pdf->Cell(40, 5, $fila['numero'], 1, 0, "C");
